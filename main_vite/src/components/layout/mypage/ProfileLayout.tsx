          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <li className="profilelist">
                ...
                <input id="name" className="tex w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-400" type="text" name="name" />
              </li>
              <li className="profilelist">
                <label htmlFor="email" className="block text-gray-600">Email:</label>
                <input id="email" className="tex w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-400" type="text" value="abcd@abc.amail" readOnly />
              </li>
              <li className="profilelist">
                <label htmlFor="phone" className="block text-gray-600">Phone:</label>
                <input id="phone" className="tex w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-400" type="text" />
              </li>
              <li className="profilelist">
