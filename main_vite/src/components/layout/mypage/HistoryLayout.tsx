  ...
  const [items] = useState([
    {
      ...
      status: "Paid",
      image:
        "https://search.pstatic.net/sunny/?src=https%3A%2F%2Fi.pinimg.com%2F736x%2F52%2Fe9%2F1c%2F52e91cb563dce997d5f8a03da26b92cb.jpg&type=sc960_832",
    },
    {
      id: 2,
      date: "2024년 4월 6일",
      ...
      status: "Paid",
      image:
        "https://search.pstatic.net/common/?src=http%3A%2F%2Fshop1.phinf.naver.net%2F20240407_146%2F1712491384777UNT1J_JPEG%2F58124022480934754_1083232035.jpeg&type=sc960_832",
    },
    {
      id: 3,
      date: "2024년 3월 6일",
      ...
      status: "Paid",
      image:
        "https://search.pstatic.net/common/?src=http%3A%2F%2Fshop1.phinf.naver.net%2F20231221_220%2F1703141893737BfeBX_JPEG%2F8742264532845654_1074588519.jpeg&type=sc960_832",
    },
    {
      id: 4,
      date: "2024년 2월 6일",
              ...
              {currentItems.map((item) => (
                <tr key={item.id}>
                  ...
                  <td>
                    <Link
                      to={"./MyHistoryDetail"}
                      className="bg-pink-400 hover:bg-pink-500 text-white font-bold py-0.8 px-3 rounded w-30 w-fixed-width"
                    >
                      invoice
                    </Link>
                  </td>
